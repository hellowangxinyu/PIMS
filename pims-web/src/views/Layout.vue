...
const pageTitle = computed(() => {
  const map = {
    ...
    '/report-ar': '应收明细', '/report-ap': '应付明细', '/report-ar-total': '应收总表', '/report-ap-total': '应付总表', '/report-finance-trend': '趋势分析', '/payment-receipt': '收款单', '/payment-disbursement': '付款单', '/crm-pipeline': '商机管道', '/crm-contact': '联系人', '/quotation': '报价单', '/sample': '打样样品', '/complaint': '客户投诉', '/weekly-topic': '每周议题', '/rd-progress': '研发进度', '/invoice': '发票管理', '/expense': '费用管理', '/advance': '预收预付', '/cost-accounting': '成本核算', '/report-profit-trial': '利润试算', '/customer-statement': '客户对账单', '/users': '用户管理', '/roles': '角色权限', '/dict': '数据字典', '/ai': 'AI 智能助手', '/ai-settings': 'AI 设置', '/logs': '操作日志', '/coding-rule': '编码规则',
