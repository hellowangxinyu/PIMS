...
export function buildQcReportHtml(row, items, opts = {}) {
  ...
  return [
    ...
    '.preview-bar{background:#f0ece0;border:1px solid #d6cca6;border-radius:6px;padding:10px 16px;font-size:13px;color:#8a6d1a;margin-bottom:16px;display:flex;align-items:center;justify-content:space-between;}',
    '.preview-print{background:#fff;border:1px solid #bfae7f;color:#8a6d1a;border-radius:4px;padding:5px 16px;cursor:pointer;font-size:13px;}',
    '.preview-print:hover{background:#ece5d2;}',
