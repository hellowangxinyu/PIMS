import{f as x}from"./fmt-DziXqmun.js";import{e as w,am as J,o as p,ao as S,aq as d,aF as b,aG as m,c as N,au as _,ar as M,at as n,aH as y,aw as Q,r as h,aI as D,as as W,aA as z,av as K,aB as Y}from"./vendor-HeQuGRwM.js";import{a as B}from"./index-_lURtROE.js";import{_ as R}from"./index-B9p5CYXo.js";function g(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function c(i){return Number(i||0).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}function X(i){const s=i.customer||{},u=i.lines||[];let r=Number(i.opening||0);const a=u.map(t=>(r+=Number(t.debit||0)-Number(t.credit||0),`<tr>
