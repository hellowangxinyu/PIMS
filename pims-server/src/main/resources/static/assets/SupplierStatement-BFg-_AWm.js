import{_ as A,l as k,o as J,b as p,c as S,e as d,an as b,ao as m,au as w,g as x,F as V,t as r,h as Q,aq as _,ar as D,f as W,k as $,n as G,E as I}from"./index-hZHe4RZR.js";import{a as M}from"./index-CXWdiVDa.js";function h(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function c(l){return Number(l||0).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}function K(l){const n=l.supplier||{},u=l.lines||[];let s=Number(l.opening||0);const o=u.map(t=>(s+=Number(t.debit||0)-Number(t.credit||0),`<tr>
