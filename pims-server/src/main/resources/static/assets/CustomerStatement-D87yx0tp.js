import{f as x}from"./fmt-DziXqmun.js";import{e as $,an as J,o as p,ao as S,aq as d,aF as m,aG as g,c as N,au as _,ar as Y,at as n,aH as h,aw as Q,r as y,aI as D,as as W,aA as z,av as K,aB as B}from"./vendor-DecCRiBa.js";import{a as T}from"./index-DZ-orD4j.js";import{t as R}from"./date-eaW13Rd7.js";import{_ as X}from"./index-BJcxFHek.js";function v(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function u(l){return Number(l||0).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}function Z(l){const r=l.customer||{},b=l.lines||[];let s=Number(l.opening||0);const a=b.map(t=>(s+=Number(t.debit||0)-Number(t.credit||0),`<tr>
