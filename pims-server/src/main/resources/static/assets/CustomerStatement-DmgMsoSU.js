import{f as x}from"./fmt-DziXqmun.js";import{e as $,an as J,o as p,ao as S,aq as d,aF as m,aG as g,c as N,au as _,ar as Y,at as r,aH as h,aw as Q,r as y,aI as M,as as W,aA as z,av as K,aB as B}from"./vendor-CPRsvqa0.js";import{a as T}from"./index-BXKmxhh5.js";import{t as R}from"./date-eaW13Rd7.js";import{_ as X}from"./index-Dei1Wc8I.js";function v(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function u(l){return Number(l||0).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}function Z(l){const n=l.customer||{},b=l.lines||[];let s=Number(l.opening||0);const a=b.map(t=>(s+=Number(t.debit||0)-Number(t.credit||0),`<tr>
...
</html>`}function ee(l){const n=window.open("","_blank");return n?(n.document.write(Z(l)),n.document.close(),n.focus(),setTimeout(()=>{n.print(),n.close()},200),!0):!1}const te={class:"report-page"},de={class:"toolbar"},ae={key:0,class:"kpi-row"},oe={class:"kpi-card"},le={class:"kpi-value"},ie={class:"kpi-card"},ne={class:"kpi-value"},re={class:"kpi-card"},se={class:"kpi-value green"},pe={class:"kpi-card"},ce={class:"kpi-value"},ue={class:"kpi-card"},be={class:"table-card"},me={class:"card-title"},ge={key:2,class:"empty-tip"},ve={__name:"CustomerStatement",setup(l){const n=$([]),b=$(null),s=$(I()),a=$(null),t=$(!1),f=$([]);function I(){const o=new Date,e=new Date(o.getFullYear(),Math.floor(o.getMonth()/3)*3,1),c=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,k=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`;return[c,k]}function P(o){return f.value.includes(o)}function C(o){return f.value.includes(o+":amount")||f.value.includes("finance:amount")}const H=M(()=>{var o;return(((o=a.value)==null?void 0:o.lines)||[]).filter(e=>e.type==="收款").reduce((e,c)=>e+Number(c.credit||0),0)}),L=M(()=>{var o;return(((o=a.value)==null?void 0:o.lines)||[]).filter(e=>e.type==="销售退货").reduce((e,c)=>e+Number(c.credit||0),0)}),j=M(()=>{var e,c;let o=Math.round(Number(((e=a.value)==null?void 0:e.opening)||0)*100);return(((c=a.value)==null?void 0:c.lines)||[]).map(k=>(o+=Math.round(Number(k.debit||0)*100)-Math.round(Number(k.credit||0)*100),{...k,balance:o/100}))});async function A(){if(!b.value||!s.value||s.value.length!==2){B.warning("请选择客户和对账期间");return}t.value=!0;try{a.value=await T.get("/finance-report/statement",{params:{customerId:b.value,from:s.value[0],to:s.value[1]}})}catch{}finally{t.value=!1}}function E(){ee(a.value)||B.warning("浏览器拦截了弹窗，请允许本站弹出窗口")}return J(async()=>{try{f.value=JSON.parse(localStorage.getItem("user")||"{}").permissions||[]}catch{}try{n.value=await T.get("/customer",{params:{enabled:!0}})}catch{}}),(o,e)=>{var V,F;const c=y("el-option"),k=y("el-select"),O=y("el-date-picker"),D=y("el-button"),U=y("el-skeleton"),w=y("el-table-column"),q=y("el-tag"),G=y("p-table");return p(),S("div",te,[e[9]||(e[9]=d("div",{class:"report-header"},[d("h2",{class:"report-title"},"客户对账单"),d("span",{class:"report-sub"},"期间往来明细 + 期末余额 · 可打印盖章确认")],-1)),d("div",de,[m(k,{modelValue:b.value,"onUpdate:modelValue":e[0]||(e[0]=i=>b.value=i),filterable:"",placeholder:"选择客户",style:{width:"220px"}},{default:g(()=>[(p(!0),S(Y,null,W(n.value,i=>(p(),N(c,{key:i.id,label:i.name,value:i.id},null,8,["label","value"]))),128))]),_:1},8,["modelValue"]),m(O,{modelValue:s.value,"onUpdate:modelValue":e[1]||(e[1]=i=>s.value=i),type:"daterange","value-format":"YYYY-MM-DD","range-separator":"至","start-placeholder":"开始日期","end-placeholder":"结束日期",style:{width:"260px"}},null,8,["modelValue"]),m(D,{type:"primary",onClick:A,loading:t.value,disabled:!b.value||!s.value},{default:g(()=>[...e[2]||(e[2]=[z("查询",-1)])]),_:1},8,["loading","disabled"]),P("finance:read")?(p(),N(D,{key:0,onClick:E,disabled:!a.value},{default:g(()=>[...e[3]||(e[3]=[z("打印对账单",-1)])]),_:1},8,["disabled"])):_("",!0)]),t.value?(p(),N(U,{key:0,rows:8,animated:""})):_("",!0),a.value&&!t.value?(p(),S(Y,{key:1},[C("finance-report")?(p(),S("div",ae,[d("div",oe,[e[4]||(e[4]=d("div",{class:"kpi-label"},"期初余额",-1)),d("div",le,"¥"+r(h(x)(a.value.opening)),1)]),d("div",ie,[e[5]||(e[5]=d("div",{class:"kpi-label"},"本期应收增加",-1)),d("div",ne,"¥"+r(h(x)(a.value.debit)),1)]),d("div",re,[e[6]||(e[6]=d("div",{class:"kpi-label"},"本期收款",-1)),d("div",se,"¥"+r(h(x)(H.value)),1)]),d("div",pe,[e[7]||(e[7]=d("div",{class:"kpi-label"},"本期退货",-1)),d("div",ce,"¥"+r(h(x)(L.value)),1)]),d("div",ue,[e[8]||(e[8]=d("div",{class:"kpi-label"},"期末余额（客户应付）",-1)),d("div",{class:Q(["kpi-value",a.value.closing>0?"red":"green"])},[d("b",null,"¥"+r(h(x)(a.value.closing)),1)],2)])])):_("",!0),d("div",be,[d("div",me,r((V=a.value.customer)==null?void 0:V.name)+"（"+r(a.value.from)+" 至 "+r(a.value.to)+"）"+r((F=a.value.customer)!=null&&F.taxNo?" · 税号 "+a.value.customer.taxNo:""),1),m(G,{data:j.value,stripe:"",border:"",style:{width:"100%"}},{default:g(()=>[m(w,{prop:"date",label:"日期",width:"110"}),m(w,{prop:"docNo",label:"单据号","min-width":"140","show-overflow-tooltip":""}),m(w,{prop:"type",label:"业务类型",width:"100",align:"center"},{default:g(({row:i})=>[m(q,{type:{销售立账:"primary",收款:"success",销售退货:"warning"}[i.type]||"info",size:"small"},{default:g(()=>[z(r(i.type),1)]),_:2},1032,["type"])]),_:1}),m(w,{prop:"note",label:"摘要","min-width":"170","show-overflow-tooltip":""}),C("finance-report")?(p(),N(w,{key:0,prop:"debit",label:"应收增加",width:"120",align:"right"},{default:g(({row:i})=>[z(r(i.debit?"¥"+h(x)(i.debit):""),1)]),_:1})):_("",!0),C("finance-report")?(p(),N(w,{key:1,prop:"credit",label:"收款/退货",width:"120",align:"right"},{default:g(({row:i})=>[z(r(i.credit?"¥"+h(x)(i.credit):""),1)]),_:1})):_("",!0),C("finance-report")?(p(),N(w,{key:2,prop:"balance",label:"结转余额",width:"130",align:"right"},{default:g(({row:i})=>[d("span",{style:K(i.balance<0?"color:#ef4444":"")},"¥"+r(h(x)(i.balance)),5)]),_:1})):_("",!0)]),_:1},8,["data"])])],64)):_("",!0),!a.value&&!t.value?(p(),S("div",ge,"选择客户和对账期间后查询")):_("",!0)])}}},ke=X(ve,[["__scopeId","data-v-4c4ff21a"]]);export{ke as default};
