import{_ as J,l as k,o as Q,b as p,c as $,e as d,am as b,an as m,at as w,g as _,F as I,t as s,h as W,ap as h,aq as C,f as G,k as S,n as K,E as M}from"./index-Bb85erhR.js";import{a as Y}from"./index-DMuIUOGg.js";function g(l){return String(l??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function c(l){return Number(l||0).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}function R(l){const n=l.customer||{},u=l.lines||[];let r=Number(l.opening||0);const i=u.map(t=>(r+=Number(t.debit||0)-Number(t.credit||0),`<tr>
